    ...
    <main class="caixa-main-login">
        <form class="caixa-form-login" method="POST">
            ...
            <div class="caixa-div-login">
                ...
                <!-- <div class="caixa-input-login" style="color: white;">
                    <input type="checkbox" name="salvar" id="salvar" style="animation: none; border: none; box-shadow: none;">Manter Login
                </div> -->
            </div>
