...
<head>
    ...
    <title>BlockStone - Gestão de Estoque</title>
...
<body>
            ...
            <div class="modal-linha">
                <div class="modal-item">
                    ...
                    <select name="produto" id="produto">
                        ...
                        if (mysqli_num_rows($executando) > 0) {
                            echo "<option value='Vazio' disabled selected>Selecione uma Opção</option>";
                            while ($linha = mysqli_fetch_array($executando)) {
    ...
    <!-- MODAL EDIT -->
    <section class="modal-fundo" id="modalEdicao" <?php
        ...
        <form class="modal-form" action="php/produtos/editar_produto.php" method="POST">
            ...
            if (isset($_SESSION['erro'])) {
                ...
                font-weight:bold;"><p>' . $_SESSION['erro'] . "</p></div>";
                unset($_SESSION['erro']);
            }
            ...
            <div class="modal-item" style="display: none;">
                ...
                <input type="number" name="edit-id" id="edit-id" <?php if(isset($_SESSION['previne'])) echo "value='".$_SESSION['previne']."'"; unset($_SESSION['previne']); ?>>
            </div>
            ...
            <div class="modal-item">
                ...
                <select name="edit-unidade" id="edit-unidade">
